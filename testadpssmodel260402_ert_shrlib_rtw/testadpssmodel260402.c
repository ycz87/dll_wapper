...
void testadpssmodel260402_step(void)
{
  ...
  for (i = 0; i < 3; i++) {
    _mm_storeu_pd(&tmp_1[0], _mm_add_pd(_mm_mul_pd(_mm_loadu_pd
      ...
      (testadpssmodel260402_U.In1[i])), _mm_set_pd(tmp, rtb_Gain1_i)));
    rtb_Gain1_i = tmp_1[0];
    tmp = tmp_1[1];
    tmp_0 += testadpssmodel260402_ConstP.pooled3[3 * i + 2] *
      testadpssmodel260402_U.In1[i];
  }
  ...
  testadpssmodel260402_Subsystem1(testadpssmodel260402_ConstB.Compare_l,
    &rtb_Gain1[0], testadpssmodel260402_Y.Out2, &testadpssmodel260402_B.Fcn,
  ...
  testadpssmode_Subsystempi2delay(testadpssmodel260402_ConstB.Compare_a,
    &rtb_Gain1[0], testadpssmodel260402_Y.Out2, &testadpssmodel260402_B.Fcn_i,
   ...
   *  UnitDelay: '<S2>/Unit Delay2'
   */
  rtb_Gain = 2.0 * testadpssmodel260402_Y.Out2;
   ...
   *  UnitDelay: '<S2>/Unit Delay2'
   */
  rtb_Gain1_i = -2.0 * testadpssmodel260402_Y.Out2;
  ...
  testadpssmodel260402_Subsystem1(testadpssmodel260402_ConstB.Compare_c,
    &rtb_Gain1[0], -testadpssmodel260402_Y.Out2, &testadpssmodel260402_B.Fcn_b,
  ...
  testadpssmode_Subsystempi2delay(testadpssmodel260402_ConstB.Compare_pd,
    &rtb_Gain1[0], -testadpssmodel260402_Y.Out2, &testadpssmodel260402_B.Fcn_c,
   ...
   *  Sum: '<S59>/Sum'
   */
  testadpssmodel260402_Y.Out1 = ((166.66 * rtb_Gain +
   ...
   *  UnitDelay: '<S2>/Unit Delay2'
   */
  testadpssmodel260402_Y.Out2 = rt_modd_snf
